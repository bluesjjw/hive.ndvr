 ...
 */
package cn.pku.net.db.hive.ndvr.image.analyze.harris.io;

import java.util.List;

import cn.pku.net.db.hive.ndvr.image.analyze.harissurf.SURFInterestPoint;

/**
 * 类InterestPointFileList.java的实现描述：每张图片的SURFInterestPoint信息，用于缓存logo信息。
 * 其中width和height在比较的时候需要用到，maxSize为 该图片需要的最少匹配点数
 * 
